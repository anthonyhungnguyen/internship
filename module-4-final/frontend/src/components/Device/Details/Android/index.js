...
export default () => {
	...
	return (
		<React.Fragment>
			...
			<Row label="OS Version Name" data={os_version_name} />
			...
			<Row label="Device First Boot" data={hw_released} />
			<Row label="CPU Name" data={hw_cpu_name} />
			<Row label="CPU Manufacturer" data={hw_cpu_manufacturer} />
			...
			<Row label="Bluetooth Address" data={hw_bluetooth_address} />
