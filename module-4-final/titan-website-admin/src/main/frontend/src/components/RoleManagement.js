			...
			<div className="animated fadeIn">
				<Row>
					<Col xl={12}>
						<Card>
							<CardHeader>
								<i className="fa fa-align-justify" /> Role management
								<Button color="success" size="md" className="float-right" onClick={this.toggleNewRole}>
									<i className="fa fa-plus" />
									<b> Add new</b>
									<Modal size="md" isOpen={this.state.modalNewRole} toggle={this.toggleNewRole}>
										<ModalHeader toggle={this.toggleNewRole}>Add new role</ModalHeader>
										<ModalBody
													...
													<Form>
														<FormGroup row>
															<Col md={4}>
																<Label>
																	<b>
																		Full name<span style={{ color: '#F86C6B' }}>*</span>
																	</b>
																</Label>
															</Col>
															<Col md={8}>
																<AntInput
																	...
																	onChange={this.handleChangeNewRoleName}
																	required
																/>
															</Col>
														</FormGroup>
														...
														<FormGroup row>
															<Col md={4}>
																<Label>
																	<b>
																		Domain<span style={{ color: '#F86C6B' }}>*</span>
																	</b>
																</Label>
															</Col>
															<Col md={8}>
																<AntInput
																	...
																	onChange={this.handleChangeNewRoleDomain}
																	required
																/>
															</Col>
														</FormGroup>
														...
														<FormGroup row>
															<Col md={4}>
																<Label>
																	<b>
																		Role<span style={{ color: '#F86C6B' }}>*</span>
																	</b>
																</Label>
															</Col>
															<Col md={8}>
														...
														<FormGroup row>
															<Col md={4}>
																<Label>
																	<b>
																		Status<span style={{ color: '#F86C6B' }} />
																	</b>
																</Label>
															</Col>
															<Col md={8}>
																<Switch
																	defaultChecked
																	onChange={this.handleChangeNewRoleStatus}
																/>
															</Col>
														</FormGroup>
													</Form>
										...
										<ModalFooter>
											<Button color="secondary" onClick={this.toggleNewRole}>
												Cancel
											</Button>

											<Button color="primary" onClick={this.handleNewRole}>
												Add
											</Button>
										</ModalFooter>
									</Modal>
								...
								<Row>
									<Col md={3}>
										<AntInput
											...
											onChange={(value) => this.searchInResult(value)}
										/>
									</Col>
									<Col md={3}>
										<Select
											...
											style={{ width: '100%' }}
											onChange={(value) => this.searchRole(value)}
										>
											{rolesListSearchSuggest.map((ele) => <Option value={ele}>{ele}</Option>)}
										</Select>
									</Col>
								</Row>
								<br />
