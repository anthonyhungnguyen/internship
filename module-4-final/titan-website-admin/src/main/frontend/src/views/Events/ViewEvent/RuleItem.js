...
class RuleItem extends React.Component{
    constructor(props){
        ...
        this.state={
            ...
            actionCode:props.rule.actionCode,
                ...
                if (tier.id.toString()===this.props.tierId.toString()){
                  tier.listRules.map(rule=>{
                    if (rule.id.toString()===this.props.rule.id.toString()){
                        ...
                        rule.actionCode = newRule.actionCodeSuggest.find(ele=>ele.id.toString()===newRule.actionCode.toString())
        ...
        return(
            <Card>
                ...
                <CardHeader>
                    ...
                    <div><strong>InfoCode: </strong> <span style={{color:"red"}}>[{this.state.rule.infoCode.id}]</span> {this.state.rule.infoCode.message} &mdash; {this.state.rule.infoCode.description}</div>
                    <div><strong>ActionCode: </strong> <span style={{color:"red"}}>[{this.state.rule.actionCode?this.state.rule.actionCode.id:""}]</span> {this.state.rule.actionCode?this.state.rule.actionCode.message:""}</div>
